...
export const products: Products = {
  finlink: {
    ...
    solution:
      "Finlink enables real-time financial data access, AI-driven underwriting, and instant credit decisioning using Account Aggregator ecosystem.",
    features: [
  ...
  coursify: {
    ...
    solution:
      "Coursify delivers adaptive, AI-driven learning experiences with personalized paths and real-time analytics.",
    features: [
  ...
  Qualvo: {
    ...
    solution:
      "Qualvo automates testing with AI-powered test generation and self-healing capabilities.",
    features: [
  ...
  facentra: {
    ...
    solution:
      "Facentra provides secure, location-aware workforce management using face recognition and geofencing.",
    features: [
