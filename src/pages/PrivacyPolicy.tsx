      ...
      <section className="legal-content">
        <div className="legal-content__container">
          ...
          >
            ...
            <p>
              At Ajuserv, protecting your privacy is a top priority. This Privacy Policy explains how your information is collected, used, disclosed, and safeguarded when you visit our website, use our platforms including Coursify, Finlink, Qualev, and Facentra, or engage with any of our services.
            </p>
            <p>
              By accessing or using our services, you agree to this Privacy Policy. If you do not agree with the terms outlined here, please do not access our services.
            </p>
            ...
            <ul>
              <li><strong>Coursify:</strong> Learning progress, course completions, assessment results</li>
              <li><strong>Finlink:</strong> Financial data as authorized through Account Aggregator framework</li>
              <li><strong>Qualev:</strong> Testing configurations, automation scripts, test results</li>
              <li><strong>Facentra:</strong> Biometric data (facial recognition), attendance records, location data</li>
            </ul>
            ...
            <p>
              We retain your information for as long as necessary to fulfill the purposes outlined in this Privacy Policy, unless a longer retention period is required or permitted by law. When data is no longer needed, we securely delete or anonymize it.
            </p>
            ...
            <p>To exercise these rights, please contact us at <a href="mailto:privacy@ajuserv.com">privacy@ajuserv.com</a>.</p>

            <h2>8. Cookies and Tracking Technologies</h2>
            <p>
              We use cookies and similar tracking technologies to collect and track information about your browsing activities. You can control cookies through your browser settings, but disabling cookies may limit your ability to use certain features of our services.
            </p>
            ...
            <div className="legal-contact">
              ...
              <p>Email: <a href="mailto:privacy@ajuserv.com">privacy@ajuserv.com</a></p>
