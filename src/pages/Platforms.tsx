...
const platformHeroItems: HeroItem[] = [
  {
    ...
    image: coursifyImg,
    title: "Coursify",
    subtitle: "AI-Enabled Smart Learning Platform",
    label: "Coursify",
  },
  {
    id: 2,
    image: finlinkImg,
    title: "Finlink",
    subtitle: "AA-Powered Digital Lending Platform",
    label: "Finlink",
  },
  {
    id: 3,
    image: QualvoImg,
    title: "Qualvo",
    subtitle: "AI-Driven Autonomous Testing Platform",
    label: "Qualvo",
  },
  {
    id: 4,
    image: facentraImg,
    title: "Facentra",
    subtitle: "Geofenced Workforce Management System",
    label: "Facentra",
  },
];
...
const gradients: { [key: string]: string } = {
  ...
  Qualvo: "linear-gradient(135deg, #F59E0B 0%, #EF4444 100%)",
            ...
            return (
              ...
              >
                ...
                <div className="platform-card__content">
                  <h2>{platform.name}</h2>
                  <p className="platform-card__tagline">
                    {product?.tagline || platform.desc}
                  </p>
